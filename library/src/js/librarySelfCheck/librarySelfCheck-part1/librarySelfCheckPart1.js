console.log(`
      **ТЗ** 
https://github.com/rolling-scopes-school/tasks/blob/master/tasks/library/library-part1.md
...
Eсли есть предупреждения - warnings, но нет ошибок - errors, выставляем половину баллов за пункт требований.
...
Отзыв: три списка есть в работе

8) Семь кнопок "button"

9) Два инпута "input"

Отзыв: 4 input type radio (favorites section), 2 input type="tel" && type="text" (library-card section)
